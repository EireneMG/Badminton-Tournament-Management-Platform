        ...
        <div class="max-w-4xl w-full">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
                ...
                <a href="/register" class="group">
                    <div class="bg-white rounded-2xl p-8 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 border-4 border-transparent hover:border-[#D4A574] h-full flex flex-col">
